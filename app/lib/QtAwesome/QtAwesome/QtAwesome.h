...
namespace fa
{
    ...
    public:
        ...
        static const QFont::Weight FA_DUOTONE_FONT_WEIGHT =
            QFont::Black; // DEPRECATED: use FA_DUOTONE_FONT_SOLID_WEIGHT
    ...
    private:
        ...
        QHash<int, QHash<QString, int>*>
            _namedCodepointsByStyle;                      ///< A map with names mapped to code-points for each style
