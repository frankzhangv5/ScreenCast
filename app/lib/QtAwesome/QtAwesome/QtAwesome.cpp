...
#include "QtAwesomeStringGenerated.h"
    ...
    public:
                           ...
                           const QVariantMap& options)
        {
            ...
            {
                drawSize = static_cast<int>(ft.pixelSize() * qMin(textRect.width() * 0.95 / tbr.width(),
...
#ifdef FONT_AWESOME_PRO
    const QString QtAwesome::FA_DUOTONE_FONT_FILENAME =
        "pro/Font Awesome 6 Duotone-Solid-900.otf"; // DEPRECATED, use FA_DUOTONE_SOLID_FONT_FILENAME
    ...
    const QString QtAwesome::FA_SHARP_DUOTONE_REGULAR_FONT_FILENAME =
        "pro/Font Awesome 6 Sharp Duotone-Regular-400.otf";
    ...
    QtAwesome::QtAwesome(QObject* parent) : QObject(parent), _namedCodepointsByStyle(), _namedCodepointsList()
    {
        resetDefaultOptions();
        ...
        _fontDetails.insert(fa::fa_duotone,
                            QtAwesomeFontData(FA_DUOTONE_FONT_FILENAME, FA_DUOTONE_FONT_WEIGHT)); // DEPRECATED
        _fontDetails.insert(fa::fa_duotone_solid,
                            QtAwesomeFontData(FA_DUOTONE_SOLID_FONT_FILENAME, FA_DUOTONE_SOLID_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_duotone_regular,
                            QtAwesomeFontData(FA_DUOTONE_REGULAR_FONT_FILENAME, FA_DUOTONE_REGULAR_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_duotone_light,
                            QtAwesomeFontData(FA_DUOTONE_LIGHT_FONT_FILENAME, FA_DUOTONE_LIGHT_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_duotone_thin,
                            QtAwesomeFontData(FA_DUOTONE_THIN_FONT_FILENAME, FA_DUOTONE_THIN_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_sharp_solid,
                            QtAwesomeFontData(FA_SHARP_SOLID_FONT_FILENAME, FA_SHARP_SOLID_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_sharp_regular,
                            QtAwesomeFontData(FA_SHARP_REGULAR_FONT_FILENAME, FA_SHARP_REGULAR_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_sharp_light,
                            QtAwesomeFontData(FA_SHARP_LIGHT_FONT_FILENAME, FA_SHARP_LIGHT_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_sharp_thin,
                            QtAwesomeFontData(FA_SHARP_THIN_FONT_FILENAME, FA_SHARP_THIN_FONT_WEIGHT));
        _fontDetails.insert(
            fa::fa_sharp_duotone_solid,
            QtAwesomeFontData(FA_SHARP_DUOTONE_SOLID_FONT_FILENAME, FA_SHARP_DUOTONE_SOLID_FONT_WEIGHT));
        _fontDetails.insert(
            fa::fa_sharp_duotone_regular,
            QtAwesomeFontData(FA_SHARP_DUOTONE_REGULAR_FONT_FILENAME, FA_SHARP_DUOTONE_REGULAR_FONT_WEIGHT));
        _fontDetails.insert(
            fa::fa_sharp_duotone_light,
            QtAwesomeFontData(FA_SHARP_DUOTONE_LIGHT_FONT_FILENAME, FA_SHARP_DUOTONE_LIGHT_FONT_WEIGHT));
        _fontDetails.insert(fa::fa_sharp_duotone_thin,
                            QtAwesomeFontData(FA_SHARP_DUOTONE_THIN_FONT_FILENAME, FA_SHARP_DUOTONE_THIN_FONT_WEIGHT));
#endif

#ifdef USE_COLOR_SCHEME
        // support dark/light mode
        QObject::connect(
            QApplication::styleHints(), &QStyleHints::colorSchemeChanged, this, [this](Qt::ColorScheme colorScheme) {
    ...
    void QtAwesome::resetDefaultOptions()
    {
        ...
        setDefaultOption("color-selected",
                         QApplication::palette().color(
                             QPalette::Active, QPalette::Text)); // TODO: check how to get the correct highlighted color
...
#else
        addToNamedCodePoints(
            fa::fa_regular, faRegularFreeIconArray, sizeof(faRegularFreeIconArray) / sizeof(QtAwesomeNamedIcon));
#endif
    ...
    {
        if (!_namedCodepointsByStyle.contains(style))
    ...
    QVariant QtAwesome::defaultOption(const QString& name) { return _defaultOptions.value(name); }
    ...
    /// \brief QtAwesome::font Creates/Gets the icon font with a given size in pixels. This can be usefull to use a
    ...
    {
        if (!_fontDetails.contains(style))
            return QFont();
    ...
    int QtAwesome::stringToStyleEnum(const QString style) const
    {
        if (style == "fa-solid")
            ...
            return fa::fa_light;
        else if (style == "fa-thin")
            return fa::fa_thin;
        else if (style == "fa-duotone")
            return fa::fa_duotone; // DEPRECATED
        else if (style == "fa-duotone-solid")
            return fa::fa_duotone_solid;
        else if (style == "fa-duotone-regular")
            return fa::fa_duotone_regular;
        else if (style == "fa-duotone-light")
            return fa::fa_duotone_light;
        else if (style == "fa-duotone-thin")
            return fa::fa_duotone_thin;
        else if (style == "fa-sharp-solid")
            return fa::fa_sharp_solid;
        else if (style == "fa-sharp-regular")
            return fa::fa_sharp_regular;
        else if (style == "fa-sharp-light")
            return fa::fa_sharp_light;
        else if (style == "fa-sharp-thin")
            return fa::fa_sharp_thin;
        else if (style == "fa-sharp-duotone-solid")
            return fa::fa_sharp_duotone_solid;
        else if (style == "fa-sharp-duotone-regular")
            return fa::fa_sharp_duotone_regular;
        else if (style == "fa-sharp-duotone-light")
            return fa::fa_sharp_duotone_light;
        else if (style == "fa-sharp-duotone-thin")
            return fa::fa_sharp_duotone_thin;
#endif
        return fa::fa_solid;
    }
    ...
    const QString QtAwesome::styleEnumToString(int style) const
    {
        switch (style)
        {
            ...
            case fa::fa_duotone_solid:
                return "fa-duotone-solid";
            case fa::fa_duotone_regular:
                return "fa-duotone-regular";
            case fa::fa_duotone_light:
                return "fa-duotone-light";
            case fa::fa_duotone_thin:
                return "fa-duotone-thin";
            case fa::fa_sharp_solid:
                return "fa-sharp-solid";
            case fa::fa_sharp_regular:
                return "fa-sharp-regular";
            case fa::fa_sharp_light:
                return "fa-sharp-light";
            case fa::fa_sharp_thin:
                return "fa-sharp-thin";
            case fa::fa_sharp_duotone_solid:
                return "fa-sharp-duotone-solid";
            case fa::fa_sharp_duotone_regular:
                return "fa-sharp-duotone-regular";
            case fa::fa_sharp_duotone_light:
                return "fa-sharp-duotone-light";
            case fa::fa_sharp_duotone_thin:
                return "fa-sharp-duotone-thin";
#endif
        }
        return "fa-solid";
    }
    ...
    QtAwesomeFontData::QtAwesomeFontData(const QString& fontFileName, QFont::Weight fontWeight)
        : _fontFamily(QString()), _fontFilename(fontFileName), _fontId(-1), _fontWeight(fontWeight)
    {
    }

    const QString& QtAwesomeFontData::fontFamily() const { return _fontFamily; }

    void QtAwesomeFontData::setFontFamily(const QString& family) { _fontFamily = family; }

    const QString& QtAwesomeFontData::fontFilename() const { return _fontFilename; }

    int QtAwesomeFontData::fontId() const { return _fontId; }

    void QtAwesomeFontData::setFontId(int id) { _fontId = id; }

    QFont::Weight QtAwesomeFontData::fontWeight() const { return _fontWeight; }
    ...
    void QtAwesomeFontData::setFontWeight(QFont::Weight weight) { _fontWeight = weight; }
