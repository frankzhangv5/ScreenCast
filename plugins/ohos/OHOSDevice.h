...
/**
 * @brief OpenHarmony device proxy implementation
 *
 * Provides connection, control, and screenshot functionality for OpenHarmony (OHOS) devices.
 * Communicates with OHOS devices through HDC.
 */
